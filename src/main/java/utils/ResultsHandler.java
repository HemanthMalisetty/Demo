...
public class ResultsHandler {
    ...
    // https://github.com/Barokas/ApplitoolsTestResultHandler/blob/master/Java/src/main/java/ApplitoolsTestResultHandler/ApplitoolsTestResultsHandler.java
    ...
    public ResultsHandler(TestResults testResults, String viewkey, String ProxyServer, String ProxyPort, String ProxyUser, String ProxyPassword) throws Exception {
    ...
    public ResultsHandler(TestResults testResults, String viewkey, String ProxyServer, String ProxyPort) throws Exception {
        this(testResults, viewkey, ProxyServer, ProxyPort, "", "");
    }

    public ResultsHandler(TestResults testResults, String viewkey) throws Exception {
